...
libraryDependencies += "net.maffoo" %% "jsonquote-core" % "0.1.3"

// use one of the supported third-party json libraries
libraryDependencies += "net.maffoo" %% "jsonquote-lift" % "0.1.3"

libraryDependencies += "net.maffoo" %% "jsonquote-play" % "0.1.3"

libraryDependencies += "net.maffoo" %% "jsonquote-spray" % "0.1.3"
